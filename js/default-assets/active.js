(function ($) {
    ...
    if ($.fn.countdown) {
        ...
        $("#clock").countdown("2020/02/28", function (event) {
          var $this = $(this).html(event.strftime("<div>%m <span>Months</span></div> <div>%d <span>Days</span></div> <div>%H <span>Hours</span></div> <div>%M <span>Minutes</span></div> <div>%S <span>Seconds</span></div>"));
        });
    }
